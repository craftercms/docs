...
* CrafterCMS now uses OpenSearch for its search engine  |br|
  See `here <https://github.com/craftercms/craftercms/issues/5967>`__ for more information

  For more information on upgrading your install to OpenSearch, see :ref:``
