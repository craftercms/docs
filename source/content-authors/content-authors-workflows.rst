...
After creating/editing content, a request to publish content can be done by clicking on **Request Publish**.  A **Request Publish** submission can be initiated from a preview screen through the context nav or by clicking on the three dots next to the article in the **Sidebar** nav tree (for single items), or from the Dashboard (where items can be batch checked).

Request Publish through the context nav at the top:

.. image:: /_static/images/page/page-workflows-publish.jpg
    :width: 85 %
    :align: center
...
.. image:: /_static/images/page/page-workflows-publish2.jpg
    :width: 85 %
    :align: center
    :alt: Workflow - Request batch items for publish through Dashboard

Request Publish by clicking on the three dots next to the content from the **Sidebar** nav tree:

.. TODO: image below needs an update
...
After clicking on the **Submit** button, a notification email will be sent to the site's approvers.  Notice also, that the context nav now displays the icon for **In Workflow**
...
You'll also notice the **In Workflow** icon is displayed next to the content item in the **Sidebar** nav tree for the content you just submitted a request for publish and contains the text **Submitted for Publish**
...
Another way to access the **Approve & Publish** option is by going to the **Sidebar**, then navigate to the article you want to approve, then click on the three dots next to it.
...
Below is the dialog that loads after clicking on **Approve & Publish**.  The item scheduling selected in the dialog depends on what the requester has chosen when the request to publish was sent.  In the image below. the selected scheduling for the item is for the **Now**.  Click on **Submit** to publish the content now.
...
In the image below, the requester sent the request to publish with a schedule.  Click on the **Submit** button to schedule the publishing of the item.  The dialog with the date and time when selecting the **Later** radio button allows the approver to schedule or reschedule the submitted item.
...
.. image:: /_static/images/page/page-workflows-context-nav-scheduled.jpg
     :width: 75 %
     :align: center
...
The dashboard allows batches of scheduled and non-scheduled items to be pushed live at the same time.  Clicking on **Now**  or **Later** will change the schedule of all items to be pushed live at the same time.
