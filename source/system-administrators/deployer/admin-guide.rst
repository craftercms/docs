...
If you're using the Crafter CMS binary, starting and stopping the Deployer is very easy. From the command line, navigate to the
...
``./config/targets`` (in the case of the Crafter CMS binaries, they're under ``CRAFTER_HOME/data/deployer/targets``).
