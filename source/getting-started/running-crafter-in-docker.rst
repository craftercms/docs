...
-----------------------------------------
   ...
   .. note::
      The preferred method of installing and running Crafter CMS is via the binary download or via the binary built by the Gradle environment builder.  See the :ref:`quick_start_guide` for more information on the preferred methods of installation.
...
You may now follow the instructions listed in the guide :ref:`above:<installing-crafter-cms-from-binary-download>` starting from the step :ref:`Access Crafter Studio <accessing-crafter-studio>` to start using Crafter CMS.
