...
.. _newIa-crafter-engine-api-site-elasticsearch-search:
...
See :ref:`newIa-search-elasticsearch-multi-index-query` for more information on performing a multiple index search.
