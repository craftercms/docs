...
.. list-table::
   ...
   * - isAuthoring
     - boolean
     - Optional as it defaults to :ref:`newIa-modePreview <printIfPreview>` FreeMarker context variable. When isAuthoring=false, in context editing is skipped all together. Meant for running in production.
   * - props
     - JS object string
...
.. list-table::
   ...
   * - ``renderComponentArguments``
     - CrafterCMS' :ref:`newIa-renderComponent <renderComponent>` macro supports supplying additional arguments
