...
The macros **{yyyy}**, **{mm}** and **{dd}** are available for content modelers to use to better organize their site items.  To see other macros available for content modelers, see :ref:`newIa-macros-for-data-sources`.
