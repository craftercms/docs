...
:ref:`failure notification properties <newIa-cluster-startup-failure-notification-config>` section
...
as seen :ref:`above <newIa-cluster-troubleshooting-git-sync-fail-log>` and the following email will be sent if configured:
