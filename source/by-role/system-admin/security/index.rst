...
.. index:: Security, SAML, LDAP, Header-based, Authentication, Password, SSL, TLS, HTTPS
...
????????????????
Securing a CrafterCMS installation starts by these basic steps:
...
Follow the article :ref:`configuring-studio-security` to secure the authoring environment.
...
Follow the article :ref:`configuring-engine-security` to secure the delivery environment.
