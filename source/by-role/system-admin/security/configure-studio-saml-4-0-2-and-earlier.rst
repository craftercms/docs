...
.. meta::
   :description: Configure SAML2 SSO for CrafterCMS Crafter Studio v4.0.2 and earlier using Java KeyStore, Identity Provider settings, and studio-config-override.yaml.
