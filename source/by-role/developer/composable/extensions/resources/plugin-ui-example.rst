...
See `here <https://github.com/craftersoftware/craftercms/tree/support/4.x/studio-ui/static-assets/components/cstudio-forms/controls/date-time.js#L881>`__ for an example of calling ``registerDynamicField`` in the date-time form control code.
