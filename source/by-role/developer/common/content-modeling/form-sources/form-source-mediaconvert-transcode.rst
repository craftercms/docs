...
.. list-table::
    ...
    * - Properties
      -
    * - Input Profile Id
      - AWS profile id (MediaConvert) to be used for uploading and triggering the transcode job, setup in aws.xml
    * - Output Profile Id
      - S3 profile id to be used to access the files generated by the transcode job, setup in aws.xml
