...
Support
=======
Crafter CMS is commercialå open source project.  Every single line of source code in Crafter CMS licensed under the GPLv2 and is publicly available at `Crafter CMS / GitHub <https://github.com/craftercms>`_ and is supported by our `the Crafter CMS developer community <http://craftercms.org>`_.
