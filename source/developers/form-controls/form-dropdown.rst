...
.. image:: /_static/images/form-control-dropdown-example.png
    :width: 50%
...
.. image:: /_static/images/form-control-dropdown.png
    :width: 50%
    :alt: Form Control Dropdown
    :align: center
...
Properties             - Data Source: Source that will populate the dropdown.
                       - Allow Empty Value: To enable/disable allowing to leave the field empty.
