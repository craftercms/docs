...
.. image:: /_static/images/form-control-rte-example.png
    :width: 50%
    :alt: RTE
    :align: center
...
.. image:: /_static/images/form-control-rte-properties.png
    :width: 50%
    :alt: RTE
    :align: center
...
Properties             - Width: Width of the Rich Text Area.
                       ...
                       - Require Image Alt Tag: When inserting image, requires alternative tag.
                       - Supported Channels:
