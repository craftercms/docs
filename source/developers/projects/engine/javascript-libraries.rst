...
See the blueprint `Video Center <https://craftercms.com/marketplace/video-center-blueprint>`__ in the *Public Marketplace* when creating a site in Crafter Studio for an example of using the above JavaScript libraries.