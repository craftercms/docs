...
.. important::
   This API is deprecated and provided only as a reference.  Please see :base_url:`writeConfiguration </_static/api/studio.html#tag/configuration/operation/writeConfiguration>` for the current version.
