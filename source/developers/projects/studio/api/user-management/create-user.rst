...
.. code-block:: json
	...
	POST .../api/1/services/api/1/user/create-user.json
...
+=========+===========================================+===================================================+
|| 201    || ``.../get-user.json?username=:username`` || ``{ "status" : "OK" }``                          |
+---------+-------------------------------------------+---------------------------------------------------+
|| 401    ||                                          || ``{ "status" : "Unauthorized" }``                |
+---------+-------------------------------------------+---------------------------------------------------+
|| 409    || ``.../get-user.json?username=:username`` || ``{ "status" : "User already exists" }``         |
+---------+-------------------------------------------+---------------------------------------------------+
