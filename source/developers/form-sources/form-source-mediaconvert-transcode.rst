...
+------------------------+-----------------------------------------------------------------------------+
|| Properties            || - Input Profile ID: AWS profile id (MediaConvert) to be used to access the |
||                       ||                     files generated by the transcode job, setup in aws.xml |
||                       || - Output Profile ID: S3 profile id to be used for uploading and triggering |
||                       ||                      the transcode job, setup in aws.xml                   |
+------------------------+-----------------------------------------------------------------------------+